...
function addbill(){
  var a=document.getElementById("inputm").value;
  var b=document.getElementById("inputcost").value;
  var c=document.getElementById("inputdate").value;
  console.log(a+" "+b+" "+c);
...
function investments(){
  var a=document.getElementById("inputi").value;
  var b=document.getElementById("inputamount").value;
  var c=document.getElementById("inputdate").value;
  console.log(a+" "+b+" "+c);
  var table=document.getElementById("tablem");
  var row=table.insertRow(-1);
...
function addtax(){
  ...
  var b=document.getElementById("inputta").value;
  var c=document.getElementById("inputtd").value;
  console.log(a+" "+b+" "+c);
  var table=document.getElementById("tablem");
  var row=table.insertRow(-1);
  var cell1 = row.insertCell(0);
